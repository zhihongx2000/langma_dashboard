...
| evidences | array<EvidenceItem> | 是 | 触发判断的原话与时间点 |
...
| evidences | array<EvidenceItem> | 是 | 风险判断证据 |
...
| evidences | array<EvidenceItem> | 是 | 话术对应的证据来源 |
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data.items | array<SidebarItem> | 是 | 侧栏平铺列表，前端按 item_type 渲染 |
...
| data.messages | array<ConversationMessage> | 是 | 标准化消息列表 |
...
| data.persona_tags | array<FindingItem> | 是 | 用户标签 |
| data.pain_points | array<FindingItem> | 是 | 痛点列表 |
| data.deal_closing_points | array<FindingItem> | 是 | 成交节点列表 |
| data.churn_points | array<FindingItem> | 是 | 流失节点列表 |
| data.high_frequency_points | array<FindingItem> | 是 | 高频问题列表 |
| data.risk_assessment | RiskAssessment | 是 | 风险评估 |
| data.smart_replies | array<SmartReply> | 是 | 推荐话术列表 |
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data.items | array<PromptVersion> | 是 | Prompt 版本列表 |
...
| 字段 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- |
| data.items | array<ModelOption> | 是 | 可用模型列表 |
