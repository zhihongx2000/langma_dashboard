...
def test_parse_hlj_list_table():
    ...
    html = """<html><body><table><tbody>
      <tr>
        <td><img src="/x.gif"/><a href="./202601/t1.htm" target="_blank">测试通知</a></td>
        <td>2026-01-01</td>
      </tr>
...
def test_heilongjiang_levels_endpoint(monkeypatch):
    def fake():
        return {
            ...
            "level1": [{"name": "最新信息", "items": []}],
        }

    monkeypatch.setattr("app.routers.test_local.get_heilongjiang_levels", fake)
