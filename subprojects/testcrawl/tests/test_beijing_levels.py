...
def test_beijing_level_names():
    assert LEVEL1_NAMES == ("信息发布台", "自考政策", "近期业务", "快速通道", "必备知识")
...
def test_collect_rows_from_ul():
    html = """<ul class="com-list">
      <li><span class="li-time">2026-03-11</span><a href="/html/selfstudy/xxfbt/2026/0311/87965.html">北京市2026年上半年自学考试学士学位申报通知</a></li>
      <li><a href="https://zikao.bjeea.cn/">自考个人中心</a></li>
    </ul>"""
...
def test_beijing_levels_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("app.routers.test_local.get_beijing_levels", fake)
