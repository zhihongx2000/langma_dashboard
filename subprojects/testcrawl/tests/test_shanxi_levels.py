...
def test_extract_date_like():
    assert _extract_date_like("鍏憡 2026骞?鏈?鏃?) == "2026-04-01"
    assert _extract_date_like("x 2025-12-30") == "2025-12-30"


def test_parse_shanxi_list():
    html = """<html><body><ul>
    <li><a href="/news/202643/n0315127133.html">灞辫タ鐪?026骞磋€冭瘯璇存槑</a></li>
    </ul></body></html>"""
...
def test_shanxi_levels_endpoint(monkeypatch):
    ...
    monkeypatch.setattr("app.routers.crawler_ui.get_shanxi_levels", fake)
